  ...
  return (
    <div className="card overflow-hidden transition-all duration-300 hover:shadow-lg">
      ...
      <div className="p-5">
        ...
        {hotel.promo && (
          <div className="mt-3 bg-sage-100 p-2 rounded text-sm">
            <strong>Code promo :</strong> {hotel.promo}
          </div>
        )}
      </div>
    </div>
    ...
    <div className="section-container fade-in">
      ...
      <div className="bg-sage-50 p-6 rounded-lg border border-sage-100 max-w-2xl mx-auto">
        ...
        <div className="space-y-4 text-sage-800">
          ...
          <p>
            <strong>Codes promo :</strong> Les codes de réduction négociés pour vous sont valables jusqu'au 15 mars 2025.
            Mentionnez simplement "Mariage Tiffany & Warren" lors de votre réservation.
          </p>
        </div>
      </div>
    </div>
